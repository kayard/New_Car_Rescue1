...
import com.kuaijie.new_car_rescue.activity.StartOffActivity;
import com.kuaijie.new_car_rescue.activity.TakePhotoActivity;
        ...
        mBtnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mPaintView.getPath().isEmpty()) {
                    Toast.makeText(mContext, "请客户写下名字", Toast.LENGTH_SHORT).show();
                    return;
                }
